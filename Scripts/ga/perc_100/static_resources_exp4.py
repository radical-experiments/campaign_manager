...
if __name__ == "__main__":
    ...
    for cm_size in campaign_sizes:
        ...
        for _ in range(repetitions):
            planner = GAPlanner(campaign=campaign, resources=resources, num_oper=num_oper, sid='test1', random_init=1.0)
            tic = time()
            plan = planner.plan()
            toc = time()
    ...
    results.to_csv('../../../Data/ga/perc_100/StHomogeCampaigns_4St050HeteroResourcesGA.csv', index=False)
