...
if __name__ == "__main__":
    ...
    for res_num in num_resources:
        ...
        for _ in range(repetitions):
            ...
            results.loc[len(results)] = [res_num, 'HEFT', plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
            del planner

    results.to_csv('../../Data/heft/DynHeteroResources_StHeteroCampaignsHEFT2.csv', index=False)
