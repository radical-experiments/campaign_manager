...
if __name__ == "__main__":
    ...
    for cm_size in campaign_sizes:
        ...
        for _ in range(repetitions):
            ...
            results.loc[len(results)] = [cm_size, 'L2FF', plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
            del planner

    results.to_csv('../../Data/L2FF/StHeteroCampaigns_4DynHeteroResourcesL2FF2.csv', index=False)
