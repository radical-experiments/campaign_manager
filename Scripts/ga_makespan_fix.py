...
# ------------------------------------------------------------------------------
#
test_case = pd.read_csv('../Data/ga/perc_050/DynHeteroResources_StHeteroCampaignsGA50.csv')
...
results.to_csv('../Data/ga/perc_050/DynHeteroResources_StHeteroCampaignsGA50.csv', index=False)

test_case = pd.read_csv('../Data/ga/perc_050/DynHeteroResources_StHomoCampaignsGA50.csv')
results = pd.DataFrame(columns=['size','planner','plan','makespan', 'reactive', 'expected','mpn_snt', 'rect_snt', 'time'])
...
for idx, row in test_case.iterrows():
    ...
    time = row['time']
    results.loc[len(results)] = [size, planner, plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
results.to_csv('../Data/ga/perc_050/DynHeteroResources_StHomoCampaignsGA50.csv', index=False)

test_case = pd.read_csv('../Data/ga/perc_050/DynHomoResources_StHeteroCampaignsGA50.csv')
results = pd.DataFrame(columns=['size','planner','plan','makespan', 'reactive', 'expected','mpn_snt', 'rect_snt', 'time'])
...
for idx, row in test_case.iterrows():
    ...
    time = row['time']
    results.loc[len(results)] = [size, planner, plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
results.to_csv('../Data/ga/perc_050/DynHomoResources_StHeteroCampaignsGA50.csv', index=False)

test_case = pd.read_csv('../Data/ga/perc_050/DynHomoResources_StHomoCampaignsGA50.csv')
results = pd.DataFrame(columns=['size','planner','plan','makespan', 'reactive', 'expected','mpn_snt', 'rect_snt', 'time'])
...
for idx, row in test_case.iterrows():
    ...
    time = row['time']
    results.loc[len(results)] = [size, planner, plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
results.to_csv('../Data/ga/perc_050/DynHomoResources_StHomoCampaignsGA50.csv', index=False)

test_case = pd.read_csv('../Data/ga/perc_050/StHeteroCampaigns_4DynHeteroResourcesGA50.csv')
results = pd.DataFrame(columns=['size','planner','plan','makespan', 'reactive', 'expected','mpn_snt', 'rect_snt', 'time'])
...
for idx, row in test_case.iterrows():
    ...
    time = row['time']
    results.loc[len(results)] = [size, planner, plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
results.to_csv('../Data/ga/perc_050/StHeteroCampaigns_4DynHeteroResourcesGA50.csv', index=False)

test_case = pd.read_csv('../Data/ga/perc_050/StHeteroCampaigns_4DynHomoResourcesGA50.csv')
results = pd.DataFrame(columns=['size','planner','plan','makespan', 'reactive', 'expected','mpn_snt', 'rect_snt', 'time'])
...
for idx, row in test_case.iterrows():
    ...
    time = row['time']
    results.loc[len(results)] = [size, planner, plan, makespan, reactive, expected, makespan - expected, reactive - expected, time]
results.to_csv('../Data/ga/perc_050/StHeteroCampaigns_4DynHomoResourcesGA50.csv', index=False)

test_case = pd.read_csv('../Data/ga/perc_050/StHomoCampaigns_4DynHomoResourcesGA50.csv')
results = pd.DataFrame(columns=['size','planner','plan','makespan', 'reactive', 'expected','mpn_snt', 'rect_snt', 'time'])
